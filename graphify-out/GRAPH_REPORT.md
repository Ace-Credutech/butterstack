...
## Corpus Check
- 81 files · ~53,503 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 427 nodes · 471 edges · 72 communities detected
...
2. `WorkspaceComponent` - 20 edges
3. `PrototypePreviewComponent` - 19 edges
4. `ModulesPanelComponent` - 18 edges
...
- **Thin community `Community 43`** (2 nodes): `authGuard()`, `auth.guard.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 44`** (2 nodes): `brd-generator.ts`, `generateBrd()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

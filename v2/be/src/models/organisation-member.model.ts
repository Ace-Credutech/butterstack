...
OrganisationMember.init({
  org_id:     { type: DataTypes.UUID,   allowNull: false, primaryKey: true, references: { model: 'organisations', key: 'id' } },
  user_id:    { type: DataTypes.UUID,   allowNull: false, primaryKey: true, references: { model: 'users',         key: 'id' } },
...
OrganisationMember.belongsTo(User,         { foreignKey: 'invited_by', as: 'inviter' });

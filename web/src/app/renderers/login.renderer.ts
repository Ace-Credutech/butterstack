...
export function renderLogin(t: UITokens, ds: DesignSystem = DEFAULT_DESIGN, ctx?: PrototypeContext): string {
  ...
  return `
    <div class="min-h-screen bg-gradient-to-br from-green-50 to-white flex items-center justify-center p-8 ${ds.fontFamily}">
      <div class="w-full max-w-sm">
        <div class="flex items-center gap-2.5 justify-center mb-8">
          <div class="w-8 h-8 ${ds.primaryColor} rounded-lg flex items-center justify-center">
          ...
          <div class="space-y-4">
            ...
            <div class="flex items-center justify-between">
              <label class="flex items-center gap-2 text-sm text-gray-500">
                <input type="checkbox" class="w-4 h-4 rounded border-gray-300 text-green-600"/>
                Remember me
              </label>
